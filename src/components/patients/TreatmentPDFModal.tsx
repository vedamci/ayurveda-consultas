...
import { X, Printer, Plus, Trash2, ChevronDown, Loader2, Sparkles, CheckCircle, AlertCircle, Send, FileText, Salad, Leaf, ClipboardList, Stethoscope, Settings2, Phone, Type, Utensils, HeartHandshake, Search, Monitor, Smartphone, PauseCircle, PlayCircle, CheckSquare, Droplet, Heart } from 'lucide-react';
 ...
 export const TreatmentPDFModal: React.FC<TreatmentPDFModalProps> = ({
    ...
    const generateClientPdfBytes = async (
        ...
        const pages = container
            ...
            : [];
        if (pages.length === 0) throw new Error('No se encontraron páginas para exportar.');

        onProgress?.(62, 'Generando PDF directamente en el navegador...');
    ...
    //  3) Web sin Chromium → jsPDF en el navegador, descarga automática.
